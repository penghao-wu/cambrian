...
export CKPT_NAME="compressv_qwen7b_CLIP_mlp_baseline_finetune_738k" &&
...
python cambrian/train/train_tpu.py \
   --model_name_or_path "Qwen/Qwen2-7B-Instruct" \
    ...
    --pretrain_mm_mlp_adapter ./compressv_qwen7b_CLIP_mlp_baseline_shareGPT4V_pretrain/mm_projector.bin \
