...
export CKPT_NAME="compressv_qwen05b_CLIP_mlp_2scale_layer12_dim448_resize_ptsquare_finetune_737k" &&
...
python cambrian/train/train_tpu.py \
   --model_name_or_path "Qwen/Qwen2-0.5B-Instruct" \
    ...
    --pretrain_mm_mlp_adapter ./compressv_qwen05b_CLIP_mlp_2scale_layer12_shareGPT4V_square_pretrain/mm_projector.bin \
