...
export CKPT_NAME="debug_compressv_qwen05b_CLIP_mlp_2scale_layer12_dim448_pad_finetune_738k_lr2e4" &&
...
python cambrian/train/train_tpu.py \
   --model_name_or_path "Qwen/Qwen2-0.5B-Instruct" \
    ...
    --pretrain_mm_mlp_adapter ./compressv_qwen05b_CLIP_mlp_baseline_shareGPT4V_square_pretrain/mm_projector.bin \
    --vision_tower_aux_list '["openai/clip-vit-large-patch14-336"]' \
    --mm_vision_mlp_lr 2e-4 \
