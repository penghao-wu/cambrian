...
export CKPT_NAME="compressv_vicuna13b_CLIP_mlp_baseline_resize_finetune_738k" &&
...
python cambrian/train/train_tpu.py \
    ...
    --pretrain_mm_mlp_adapter ./compressv_vicuna13b_CLIP_mlp_baseline_shareGPT4V_resize_pretrain/mm_projector.bin \
