...
export CKPT_NAME="compressv_qwen05b_CLIP_mlp_sepffn_oproj448_layer12_msept_shareGPT4V_square_pretrain_stage2joint_TPU" &&
...
python cambrian/train/train_tpu.py \
    ...
    --pretrain_mm_mlp_adapter ./compressv_qwen05b_CLIP_mlp_sepffn_oproj448_layer12_shareGPT4V_square_pretrain_1stage_mse_TPU/mm_projector.bin \
