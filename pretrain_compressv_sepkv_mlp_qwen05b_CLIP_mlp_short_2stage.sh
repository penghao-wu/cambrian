...
export CKPT_NAME="compressv_qwen05b_CLIP_mlp_sepffn_oproj896_layer12_shareGPT4V_pad_pretrain_stage2joint_TPU" &&
...
python cambrian/train/train_tpu.py \
    ...
    --pretrain_mm_mlp_adapter ./compressv_qwen05b_CLIP_mlp_baseline_shareGPT4V_pad_pretrain_TPU/mm_projector.bin \
