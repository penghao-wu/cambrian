...
export CKPT_NAME="cambrian_qwen05b_CLIP_mlp_baseline_pad_finetune_738k_old_TPU" &&
...
python cambrian/train/train_tpu.py \
   --model_name_or_path "Qwen/Qwen2-0.5B-Instruct" \
    ...
    --pretrain_mm_mlp_adapter ./cambrian_qwen05b_CLIP_mlp_baseline_pad_pretrain_old_TPU/mm_projector.bin \
