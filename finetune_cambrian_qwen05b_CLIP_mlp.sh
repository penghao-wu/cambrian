...
export CKPT_NAME="cambrian_qwen05b_CLIP_mlp_2scale_dim448_skip12_24_finetune_737k_old_nounpad" &&
...
python cambrian/train/train_tpu.py \
   --model_name_or_path "Qwen/Qwen2-0.5B-Instruct" \
    ...
    --pretrain_mm_mlp_adapter ./cambrian_qwen05b_CLIP_mlp_2scale_dim448_skip12_24_shareGPT4V_pretrain_lr1e4_old_nounpad/mm_projector.bin \
