...
export CKPT_NAME="compressv_qwen05b_CLIP_mlp_baseline_mask_layer12_im1pos_resize_finetune_738k_TPU" &&
...
python cambrian/train/train_tpu.py \
   --model_name_or_path "Qwen/Qwen2-0.5B-Instruct" \
    ...
    --pretrain_mm_mlp_adapter ./compressv_qwen05b_CLIP_mlp_baseline_im1pos_shareGPT4V_resize_pretrain_TPU/mm_projector.bin \
