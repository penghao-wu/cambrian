...
export CKPT_NAME="compressv_vicuna7b_CLIP_mlp_2scale_layer11_padinit_resize_finetune_738k" &&
...
python cambrian/train/train_tpu.py \
    ...
    --pretrain_mm_mlp_adapter ./compressv_vicuna7b_CLIP_mlp_2scale_layer11_shareGPT4V_pad_pretrain/mm_projector.bin \
