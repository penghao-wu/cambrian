...
export CKPT_NAME="compressv_vicuna7b_CLIP_mlp_2scaleold_layer11_sepnorm_square2e4PT_pad_finetune_738k_TPU" &&
...
python cambrian/train/train_tpu.py \
    ...
    --pretrain_mm_mlp_adapter ./compressv_vicuna7b_CLIP_mlp_2scaleold_layer11_sepnorm_shareGPT4V_square_pretrain_TPU_lr2e4/mm_projector.bin \
