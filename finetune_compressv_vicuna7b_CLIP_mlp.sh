...
export CKPT_NAME="compressv_vicuna7b_CLIP_mlp_2scale_layer11_resize_finetune_738k" &&
...
python cambrian/train/train_tpu.py \
    ...
    --pretrain_mm_mlp_adapter ./compressv_vicuna7b_CLIP_mlp_2scale_layer11_shareGPT4V_resize_pretrain_lr2e4/mm_projector.bin \
