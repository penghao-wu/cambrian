...
export CKPT_NAME="compressv_vicuna7b_CLIP_mlp_2scaleold_layer11_pad_finetune_738k_TPU" &&
...
python cambrian/train/train_tpu.py \
    ...
    --pretrain_mm_mlp_adapter ./compressv_vicuna7b_CLIP_mlp_2scaleold_layer11_shareGPT4V_square_pretrain_TPU/mm_projector.bin \
