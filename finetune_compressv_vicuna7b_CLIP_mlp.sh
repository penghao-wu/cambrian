...
export CKPT_NAME="compressv_vicuna7b_CLIP_mlp_sepsa_prevalue_2scalecat_2convadd_oproj1024_layer0_pad_finetune_738k" &&
...
python cambrian/train/train_tpu.py \
    ...
    --pretrain_mm_mlp_adapter ./compressv_vicuna7b_CLIP_mlp_sepsa_prevalue_2scalecat_2convadd_oproj1024_layer0_shareGPT4V_square_pretrain_stage2joint_TPU/mm_projector.bin \
