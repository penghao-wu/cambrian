...
export CKPT_NAME="compressv_vicuna7b_CLIP_mlp_2scale_layer11_finetune_2stagefix_737k" &&
...
python cambrian/train/train_tpu.py \
    ...
    --pretrain_mm_mlp_adapter ./compressv_vicuna7b_CLIP_mlp_2scale_layer11_shareGPT4V_pretrain_stage2fix/mm_projector.bin \
