...
export CKPT_NAME="cambrian-connectoronly-3tower-llama31_8b-pretrain" &&
...
python cambrian/train/train_tpu.py \
    ...
    --version llama_v3 \
    --data_path ./sbu_allava_sharegpt4v_2500k_v3.jsonl \
    --image_folder /mnt/disks/storage/data/finetune_data \
    --vision_tower_aux_list '["siglip/CLIP-ViT-SO400M-14-384", "openai/clip-vit-large-patch14-336", "clip-convnext-XXL-multi-stage"]' \
    --vision_tower_aux_token_len_list '[576, 576, 9216]' \
    --image_token_len 576 \
    --num_query_group 3 \
