...
export CKPT_NAME="cambrian_7b_CLIP_mlp_2scale_layer11_pad_lr2e4PT_finetune_738k_old_TPU" &&
...
python cambrian/train/train_tpu.py \
    ...
    --pretrain_mm_mlp_adapter ./cambrian_7b_CLIP_mlp_2scale_layer11_shareGPT4V_pad_pretrain_lr2e4_old_TPU/mm_projector.bin \
