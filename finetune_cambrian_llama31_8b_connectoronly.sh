...
export CKPT_NAME="cambrian-connectoronly-4tower-llama31_8b-finetune" &&
...
python cambrian/train/train_tpu.py \
    ...
    --pretrain_mm_mlp_adapter ./cambrian-connectoronly-4tower-llama31_8b-finetune/mm_projector.bin \
