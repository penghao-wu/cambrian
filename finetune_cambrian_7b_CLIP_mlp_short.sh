...
export CKPT_NAME="cambrian_7b_CLIP_mlp_36_img_mlp_finetune_737k" &&
...
python cambrian/train/train_tpu.py \
    ...
    --pretrain_mm_mlp_adapter ./cambrian_7b_CLIP_mlp_36_img_mlp_shareGPT4V_pretrain/mm_projector.bin \
