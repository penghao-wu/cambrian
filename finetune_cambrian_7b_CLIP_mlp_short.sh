...
export CKPT_NAME="cambrian_7b_CLIP_mlp_36_img_mlpres_finetune_737k" &&
...
python cambrian/train/train_tpu.py \
    ...
    --pretrain_mm_mlp_adapter ./cambrian_7b_CLIP_mlp_36_img_mlpres_lr1e3_shareGPT4V_pretrain/mm_projector.bin \
