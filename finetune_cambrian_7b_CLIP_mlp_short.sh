...
export CKPT_NAME="cambrian_7b_CLIP_mlp_2scale_576_64_finetune_737k" &&
...
python cambrian/train/train_tpu.py \
    ...
    --pretrain_mm_mlp_adapter ./cambrian_7b_CLIP_mlp_2scale_576_64_shareGPT4V_pretrain_lr1e4/mm_projector.bin \
    --vision_tower_aux_list '["openai/clip-vit-large-patch14-336"]' \
    --vision_tower_aux_token_len_list '[576]' \
    --image_token_len 576 \
    --image_token_len_concise 64 \
    --num_query_group 1 \
    --query_num_list '[576]' \
    --connector_depth 3 \
    --image_position 35 \
