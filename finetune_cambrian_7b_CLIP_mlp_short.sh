...
export CKPT_NAME="cambrian_13b_CLIP_mlp_2scale_skip14_40_finetune_737k" &&
...
python cambrian/train/train_tpu.py \
    ...
    --pretrain_mm_mlp_adapter ./cambrian_13b_CLIP_mlp_2scale_skip14_40_shareGPT4V_pretrain_lr1e4/mm_projector.bin \
