...
export CKPT_NAME="cambrian_7b_CLIP_mlp_576_imgee_skip12_31_finetune_737k" &&
...
python cambrian/train/train_tpu.py \
    ...
    --pretrain_mm_mlp_adapter ./cambrian_7b_CLIP_mlp_576_imgee_skip12_31_shareGPT4V_pretrain/mm_projector.bin \
