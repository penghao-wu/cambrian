...
export CKPT_NAME="cambrian_qwen7b_CLIP_mlp_2scale_dim896_skip14_28_finetune_737k" &&
...
python cambrian/train/train_tpu.py \
   --model_name_or_path "Qwen/Qwen2-7B-Instruct" \
    ...
    --pretrain_mm_mlp_adapter ./cambrian_qwen7b_CLIP_mlp_2scale_dim896_skip14_28_shareGPT4V_pretrain_lr1e4/mm_projector.bin \
