...
export CKPT_NAME="cambrian_qwen05b_CLIP_mlp_576_finetune_737k_old_nounpad" &&
...
python cambrian/train/train_tpu.py \
    ...
    --pretrain_mm_mlp_adapter ./cambrian_qwen05b_CLIP_mlp_576_shareGPT4V_pretrain_old_nounpad/mm_projector.bin \
