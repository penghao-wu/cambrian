...
export CKPT_NAME="cambrian-connectoronly-4tower-llama31_8b-finetune_737k" &&
...
python cambrian/train/train_tpu.py \
    ...
    --pretrain_mm_mlp_adapter ./cambrian-connectoronly-4tower-llama31_8b-pretrain_1.2m/mm_projector.bin \
