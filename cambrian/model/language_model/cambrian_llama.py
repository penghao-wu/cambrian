...
class CambrianLlamaModel(CambrianMetaModel, LlamaModel):
	...
	def forward(
		...
		for i, decoder_layer in enumerate(self.layers):
			...
			assert False, ((hidden_states_vision_concise-hidden_states_vision_concise_1).max(), (hidden_states_text-hidden_states_text_1).max(), (hidden_states_sys-hidden_states_sys_1).max())
