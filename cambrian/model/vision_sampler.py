...
class VisionMLP(nn.Module):
	...
	def forward(self, input_embed, context, side_len_input, side_len_context, attention_mask=None):
		...
		input_embed = input_embed.view(bs, side_len_input, side_len_input, -1)
		context = context.view(bs, side_len_context, side_len_context, -1)
		...
		context = context.view(bs, side_len_context, side_len_context, 1, 1, -1).repeat(1, 1, 1, reduce_factor, reduce_factor, 1).flatten(1, 4)
