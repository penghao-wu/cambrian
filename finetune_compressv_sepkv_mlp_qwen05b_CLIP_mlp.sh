...
export CKPT_NAME="compressv_qwen05b_CLIP_mlp_2scaleffngate448_sepkv_ffn_layer14_2stagejoint_pad_finetune_738k_TPU" &&
...
python cambrian/train/train_tpu.py \
   --model_name_or_path "Qwen/Qwen2-0.5B-Instruct" \
    ...
    --pretrain_mm_mlp_adapter ./compressv_qwen05b_CLIP_mlp_2scaleffngate448_sepkv_ffn_layer14_shareGPT4V_square_pretrain_stage2joint/mm_projector.bin \
